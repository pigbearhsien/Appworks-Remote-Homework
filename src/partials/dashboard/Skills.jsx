...
function Skills() {
  ...
  return (
    <div className="fflex flex-col col-span-12 sm:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <header className="">
        <h2 className="font-semibold text-slate-800 dark:text-slate-100 ml-6 mt-6">
          Skills
        </h2>
      </header>
      {studentId ? (
